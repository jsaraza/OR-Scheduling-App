...
import type { NurseRole, ShiftType } from "@/contexts/NurseContext"
...
interface AddNurseModalProps {
  isOpen: boolean
  onClose: () => void
  onAdd: (nurse: any) => void
}

export default function AddNurseModal({ isOpen, onClose, onAdd }: AddNurseModalProps) {
